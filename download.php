...
if(isset($_GET["id"]))
{
    ...
    foreach($appointment_data as $appointment_row)
    {
        ...
        {
            $html .= '<tr>
            <th width="50%" align="right">Patient Name</th>
            <td>'.$patient_row["patient_first_name"].' '.$patient_row["patient_last_name"].'</td>
            </tr>

            <tr>
            <th width="50%" align="right">Contact No.</th>
            <td>'.$patient_row["patient_phone_no"].'</td>
            </tr>

            <tr>
            <th width="50%" align="right">Address</th>
        ...
        $html .= '
            ...
            <tr>
                <th width="50%" align="right">Patient come into Hospital</th>
